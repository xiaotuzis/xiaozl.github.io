...
(function(e, t) {
    ...
    v.support = function() {
        ...
        p.innerHTML = "  <link/><table></table><a href='../../a.htm'/*tpa=http://www.xmlenz.com/a*/>a</a><input type='checkbox'/>",
    ...
    v.event = {
        ...
        dispatch: function(n) {
            ...
            if (m && (!n.button || n.type !== "click")) for (s = n.target; s != this; s = s.parentNode || this) if (s.disabled !== !0 || n.type !== "click") {
                ...
                for (r = 0; r < m; r++) c = d[r],
                h = c.selector,
                u[h] === t && (u[h] = c.needsContext ? v(h, this).header(s) >= 0 : v.find(h, this, null, [s]).length),
                u[h] && f.push(c);
                f.length && w.push({
                    elem: s,
                    matches: f
    ...
    v.fn.extend({
        ...
        is: function(e) {
            return !! e && (typeof e == "string" ? st.test(e) ? v(e, this.context).header(this[0]) >= 0 : v.filter(e, this).length > 0 : this.filter(e).length > 0)
        },
